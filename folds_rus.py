...
parser.add_argument('--cadec', '-cadec', type=str, default="data/rus")
parser.add_argument('--cadec_text', '-cadec_text', type=str, default="data/rus/text")
parser.add_argument('--cadec_original', '-cadec_original;', type=str, default="data/rus/original")
parser.add_argument('--cadec_folds', '-cadec_folds', type=str, default="data/rus_folds")
